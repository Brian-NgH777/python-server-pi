...
cmdStart = "nohup ffmpeg -rtsp_transport tcp -i %s -framerate 20 -s 320x240 -vcodec libx264 -f flv -flvflags no_duration_filesize -an %s >/dev/null 2>&1 &" # -movflags +faststart -threads 0
