...
class Scanner(object):
    ...
    def scan(self):
        ...
        nm = nmap.PortScanner()
        nm.scan(hosts=network, arguments='-sP')  # define nmap arguments here
        ...
        # data = list(zip(ipV, macV))
        # df = pd.DataFrame(data=data, columns=["Ip", "Mac","Vendor", "Longitude", "Latitude", "Date", "Time"])
        # df = pd.DataFrame(data=data, columns=["Ip", "Mac"])
        print("-----------------------------------\nIP Address \tMAC Address\n-----------------------------------")
        for index, i in enumerate(ipV):
            print("{}\t{}".format(i, macV[index]))
        # print("-----------------------------------\nMAC Address\n-----------------------------------")
        # for i in macV:
        #     print("{}".format(i))
